 ...
 */
package customer.springboot.config;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String SQL_LOGIN 
            ...
            + "from c_security_user where username = ?"; // query untuk user
        ...
        private static final String SQL_ROLE 
                ...
                + "where u.username = ?"; // query untuk permission
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .hasRole("CUSTOMER_VIEW")
                    .antMatchers(HttpMethod.POST, "/api/customer/**")
                .hasRole("CUSTOMER_CREATE")
                    .antMatchers(HttpMethod.DELETE, "/api/customer/**")
                .hasRole("CUSTOMER_DELETE")
                    .antMatchers(HttpMethod.PUT, "/api/customer/**")
                .hasRole("CUSTOMER_UPDATE")
